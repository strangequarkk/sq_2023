  ...
  return (
    <section id='about' className='pt-12 max-w-[650px] mx-auto'>
      ...
      <p className='mb-2'>
        ...
        metus aliquam eleifend. Adipiscing bibendum est ultricies integer quis.
        Aliquam purus sit amet luctus. Sit amet facilisis magna etiam tempor
        orci. Quam nulla porttitor massa id neque. Convallis a cras semper
        auctor neque vitae tempus quam pellentesque. At imperdiet dui accumsan
